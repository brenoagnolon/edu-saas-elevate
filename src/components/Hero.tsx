    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center space-y-8 animate-fade-in-up">
        ...
        <h1 className="text-5xl md:text-7xl font-bold leading-tight tracking-tight">
          Transforme sua mentoria ou consultoria em um{" "}
          <span className="text-gradient">Software Educacional 
          </span>
        </h1>
        
        <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          Se diferencie no Mercado, Proporcione Experiência ao seu Aluno e Contrua Valuation Real — com recompra, previsibilidade e escalabilidade infinita sem depender do seu tempo em call's.
        </p>
